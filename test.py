...
class TestCheck (unittest.TestCase):
    ...
    #def test_check_id(self):
       ...
       # self.assertTrue(check_functions.check_user('CF00000000000001'))
       # self.assertTrue(check_functions.check_user('CF00000000000002'))
       # self.assertFalse(check_functions.check_user('89ER4'))
       # self.assertFalse(check_functions.check_user('876'))
